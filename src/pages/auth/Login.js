...
// Página de Login que utiliza um card e form para fazer a autenticação
export default class LoginPage extends React.Component {
    static contextType = AuthContext;

    constructor(props) {
        super(props);
        this.state = { username: "", password: "" }; //valores por defeito
    }
    ...
    handleSubmit(evt) {
        ...
        services.auth
            .login(this.state)
            .then((data) => {
                this.context.login({ username: this.state.username, ...data }); // todos os atributos 
