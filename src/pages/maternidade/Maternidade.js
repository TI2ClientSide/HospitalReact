...
import maternidadelogo from '../../assets/maternidadelogo.png';
import './Maternidade.css';
...
// Página para infetados na Maternidade
export default class MaternidadePage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            infetados: [],
        ...
        return (
            ...
            <div className="div">
                <Button style={{ margin: '10px 0' }} variant="outline-primary" onClick={() => this.props.history.push("/")}>
                    <FontAwesomeIcon icon={faArrowCircleLeft} />&nbsp;Back to Home</Button><h2> Maternidade </h2>
                <div className="div">
                    <table className="table">
                        <tbody>
                            <tr>
                                <th>{< Image logo={maternidadelogo} titulo="Bem-vindo à maternidade" descricao="Local de nascimento" />}</th>
                            </tr>
                        </tbody>
                    </table>
